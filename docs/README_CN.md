...
AI coding 已经不是小众玩法。最近的开源研究让这个趋势变得可量化：
...
```text
回答这个子系统怎么工作前，先跑一次 Understanding Sync check。
```
...
| Sync | 代码、配置、数据、脚本或测试发生变化 | 最小的、否则会过时的归属页面 |
